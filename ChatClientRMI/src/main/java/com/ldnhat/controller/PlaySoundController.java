...
public class PlaySoundController implements Initializable{
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        try {
            fileMp3 = currentClient.getServer()
                    .findAllFileByUserId(currentClient.getClient().getId(), Constant.MP3);
